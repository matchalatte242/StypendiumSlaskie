function dane() {
    //Tresc zadania, Postac standardowa, Postac kanoniczna, Bazowa postac kanoniczna
    [document.getElementById("sbwmaszyny").innerHTML, document.getElementById("obwm").innerHTML, document.getElementById("kbwm").innerHTML, document.getElementById("bkbwm").innerHTML] = [document.getElementById("bwmaszyny").value, document.getElementById("bwmaszyny").value, document.getElementById("bwmaszyny").value, document.getElementById("bwmaszyny").value];
    [document.getElementById("sbwludzie").innerHTML, document.getElementById("obwl").innerHTML, document.getElementById("kbwl").innerHTML, document.getElementById("bkbwl").innerHTML] = [document.getElementById("bwludzie").value, document.getElementById("bwludzie").value, document.getElementById("bwludzie").value, document.getElementById("bwludzie").value];
    [document.getElementById("sbwbarwnik").innerHTML, document.getElementById("obwb").innerHTML, document.getElementById("kbwb").innerHTML, document.getElementById("bkbwb").innerHTML] = [document.getElementById("bwbarwnik").value, document.getElementById("bwbarwnik").value, document.getElementById("bwbarwnik").value, document.getElementById("bwbarwnik").value];
    [document.getElementById("sbbmaszyny").innerHTML, document.getElementById("obbm").innerHTML, document.getElementById("kbbm").innerHTML, document.getElementById("bkbbm").innerHTML] = [document.getElementById("bbmaszyny").value, document.getElementById("bbmaszyny").value, document.getElementById("bbmaszyny").value, document.getElementById("bbmaszyny").value];
    [document.getElementById("sbbludzie").innerHTML, document.getElementById("obbl").innerHTML, document.getElementById("kbbl").innerHTML, document.getElementById("bkbbl").innerHTML] = [document.getElementById("bbludzie").value, document.getElementById("bbludzie").value, document.getElementById("bbludzie").value, document.getElementById("bbludzie").value];
    [document.getElementById("sbwzysk").innerHTML, document.getElementById("obwz").innerHTML, document.getElementById("kbwz").innerHTML, document.getElementById("bkbwz").innerHTML] = [document.getElementById("bwzysk").value, document.getElementById("bwzysk").value, document.getElementById("bwzysk").value, document.getElementById("bwzysk").value];
    [document.getElementById("sbbzysk").innerHTML, document.getElementById("obbz").innerHTML, document.getElementById("kbbz").innerHTML, document.getElementById("bkbbz").innerHTML] = [document.getElementById("bbzysk").value, document.getElementById("bbzysk").value, document.getElementById("bbzysk").value, document.getElementById("bbzysk").value];
    [document.getElementById("sdmaszyny").innerHTML, document.getElementById("odm").innerHTML, document.getElementById("kdm").innerHTML, document.getElementById("bkdm").innerHTML] = [document.getElementById("dmaszyny").value, document.getElementById("dmaszyny").value, document.getElementById("dmaszyny").value, document.getElementById("dmaszyny").value];
    [document.getElementById("sdludzie").innerHTML, document.getElementById("odl").innerHTML, document.getElementById("kdl").innerHTML, document.getElementById("bkdl").innerHTML] = [document.getElementById("dludzie").value, document.getElementById("dludzie").value, document.getElementById("dludzie").value, document.getElementById("dludzie").value];
    [document.getElementById("sdbarwnik").innerHTML, document.getElementById("odb").innerHTML, document.getElementById("kdb").innerHTML, document.getElementById("bkdb").innerHTML] = [document.getElementById("dbarwnik").value, document.getElementById("dbarwnik").value, document.getElementById("dbarwnik").value, document.getElementById("dbarwnik").value];
    ...
    while((WW[licznik-1][0]>0 || WW[licznik-1][1]>0 || WW[licznik-1][2]>0 || WW[licznik-1][3]>0 || WW[licznik-1][4]>0) && koniec==false) {
        ...
        for(let i=0; i<3; ++i) {
            if(document.getElementsByClassName(`Cb${i}`)[licznik]!=null) document.getElementsByClassName(`Cb${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`Cb${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`Cb${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`Cb${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`Cb${i}`)[licznik].innerHTML);
            if(document.getElementsByClassName(`b${i}`)[licznik]!=null) document.getElementsByClassName(`b${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`b${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`b${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`b${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`b${i}`)[licznik].innerHTML);
            if(document.getElementsByClassName(`a1${i}`)[licznik]!=null) document.getElementsByClassName(`a1${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`a1${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`a1${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`a1${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`a1${i}`)[licznik].innerHTML);
            if(document.getElementsByClassName(`a2${i}`)[licznik]!=null) document.getElementsByClassName(`a2${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`a2${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`a2${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`a2${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`a2${i}`)[licznik].innerHTML);
            if(document.getElementsByClassName(`a3${i}`)[licznik]!=null) document.getElementsByClassName(`a3${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`a3${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`a3${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`a3${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`a3${i}`)[licznik].innerHTML);
            if(document.getElementsByClassName(`a4${i}`)[licznik]!=null) document.getElementsByClassName(`a4${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`a4${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`a4${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`a4${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`a4${i}`)[licznik].innerHTML);
            if(document.getElementsByClassName(`a5${i}`)[licznik]!=null) document.getElementsByClassName(`a5${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`a5${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`a5${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`a5${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`a5${i}`)[licznik].innerHTML);
            if(document.getElementsByClassName(`I${i}`)[licznik]!=null && !document.getElementsByClassName(`I${i}`)[licznik].innerHTML) document.getElementsByClassName(`I${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`I${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`I${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`I${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`I${i}`)[licznik].innerHTML);
        }
    }

    if(document.getElementsByClassName(`W0`)[licznik]!=null) document.getElementsByClassName(`W0`)[licznik].innerHTML = (Number(document.getElementsByClassName(`W0`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`W0`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`W0`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`W0`)[licznik].innerHTML);

    for(let i=0; i<5; ++i) {
        if(document.getElementsByClassName(`Cj${i}`)[licznik]!=null) document.getElementsByClassName(`Cj${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`Cj${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`Cj${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`Cj${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`Cj${i}`)[licznik].innerHTML);
        if(document.getElementsByClassName(`W${i}`)[licznik]!=null) document.getElementsByClassName(`W${i}`)[licznik].innerHTML = (Number(document.getElementsByClassName(`W${i}`)[licznik].innerHTML)!=Math.trunc(Number(document.getElementsByClassName(`W${i}`)[licznik].innerHTML)))? Number(document.getElementsByClassName(`W${i}`)[licznik].innerHTML).toFixed(2) : Number(document.getElementsByClassName(`W${i}`)[licznik].innerHTML);
    } 

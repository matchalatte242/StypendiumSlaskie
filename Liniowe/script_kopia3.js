function dane() {
    ...
    for(let i=0; i<3; ++i) {
        document.getElementsByClassName(`Cb${i}`)[licznik].innerHTML = Number(Cb[licznik][i]).toFixed(2);
        document.getElementsByClassName(`b${i}`)[licznik].innerHTML = Number(b[licznik][i]).toFixed(2); 
        document.getElementsByClassName(`a1${i}`)[licznik].innerHTML = Number(a1[licznik][i]).toFixed(2);  
        document.getElementsByClassName(`a2${i}`)[licznik].innerHTML = Number(a2[licznik][i]).toFixed(2);  
        document.getElementsByClassName(`a3${i}`)[licznik].innerHTML = Number(a3[licznik][i]).toFixed(2); 
        document.getElementsByClassName(`a4${i}`)[licznik].innerHTML = Number(a4[licznik][i]).toFixed(2);  
        document.getElementsByClassName(`a5${i}`)[licznik].innerHTML = Number(a5[licznik][i]).toFixed(2); 
    }
